            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="#"><img src="gambar/sistem/lowi.png" alt=""></a>
                    </div>
                    <p>Cari kamar terbaik dengan harga termurah. mewah kamar nya, murah harganya.</p>
                    <a href="#"><img src="frontend/img/bri.png" alt=""></a>
                </div>
            </div>
                ...
                <div class="footer__widget">
                   <!--  <h6>NewLetter</h6> -->
                    <div class="footer__newslatter text-white">
                       <!--  <p>Follow sosial media <b>Wisma Ilham</b></p>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="footer__copyright__text">
                    ...
                    <p>Copyright © <?php echo date('Y'); ?> All rights reserved | Wisma Ilham</a></p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
        </div>
