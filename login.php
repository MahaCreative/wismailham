...
<head>
  ...
  <title>Website Wisma Ilham</title>
  ...
  <link rel="icon" href="gambar/sistem/wisma.png">
  ...
  <div class="container">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <center>
          <a href="index.php"><img width="200px" src="gambar/sistem/lo.png" alt=""></a>
        </center>
   ...
   <div class="form-group has-feedback">
            <input type="hidden" class="form-control" name="sebagai" required="required" value="admin" autocomplete="off">
